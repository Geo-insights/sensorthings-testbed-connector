"""Bridge sensor source -- loads pre-formed SensorReading objects from JSON.

No Normalizer needed: the input is already in SensorReading format, so there
are no vendor fields to map or units to enforce.
"""
